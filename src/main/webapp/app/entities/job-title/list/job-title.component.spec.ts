...
describe('JobTitle Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'job-title', component: JobTitleComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.jobTitles?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
