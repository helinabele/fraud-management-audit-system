...
/**
 * REST controller for managing {@link org.audit.app.domain.City}.
 */
@RestController
@RequestMapping("/api")
public class CityResource {
    ...
    public ResponseEntity<CityDTO> updateCity(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, cityDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<CityDTO> partialUpdateCity(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, cityDTO.getId()));
    }
