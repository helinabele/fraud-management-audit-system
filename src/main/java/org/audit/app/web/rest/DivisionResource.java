...
/**
 * REST controller for managing {@link org.audit.app.domain.Division}.
 */
@RestController
@RequestMapping("/api")
public class DivisionResource {
    ...
    public ResponseEntity<List<DivisionDTO>> getAllDivisions(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
    ...
    public ResponseEntity<DivisionDTO> getDivision(@PathVariable String id) {
